...
export const NavIconButton = ({ icon, label, onClick }: NavIconButtonProps) => (
    <div className="relative group/tip">
        <button onClick={onClick} className="cursor-pointer w-8 h-8 flex items-center justify-center rounded-md bg-zinc-300 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-200 hover:bg-zinc-200 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-100">
            {icon}
        </button>
